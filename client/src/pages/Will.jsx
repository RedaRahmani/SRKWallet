...
//       <h1 className="text-3xl font-bold mb-6 text-center">Create or Update Your Will</h1>

//       {willData ? (
//         <div>
//           <h2 className="text-xl">Will Status: {willData.status}</h2>
//           {/* Show more details about the will */}
//         </div>
//       ) : (
...
//             </div>
//           ))}
//           <button type="button" onClick={handleAddBeneficiary} className="text-blue-500">
//             Add Another Beneficiary
//           </button>

//           <h2 className="text-2xl mb-4 mt-6">Signers (Executors)</h2>
...
//           <div className="mb-4">
//             <label>Duration Before Will Execution (Months)</label>
//             <input
//               type="number"
